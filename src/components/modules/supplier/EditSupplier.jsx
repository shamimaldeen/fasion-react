...
const EditSupplier = () => {
    ...
    const  supplierUpdateForm = async ()=>
    {
        ...
        await axios.post(`${Constants.BASE_URL}/supplier/${params.id}`,formData, {
    ...
    const  handleSupplierUpdate = async (e)=>{
        e.preventDefault();
        await supplierUpdateForm();
    }

    return (
        <>
            <Breadcrumb title={"Update Supplier"} />
            <div className="row">
                <div className="col-md-12">
                    {success && <Alert className="col-sm-3 offset-3"  variant="danger">{success}</Alert>}
                    <div className="card">
                        <div className="card-header">
                            <CardHeader title={'Update Supplier'} link={'/supplier'} button_text={'Supplier List'} icon={'fa-list'} />
                        </div>
                                            ...
                                            <div className="card-body">
                                                <label className={'w-100'}>
                                                    ...
                                                    <input className={errors.name != undefined ? "form-control is-invalid" : "form-control"}
                                                           type="text" name={"name"} onChange={handleInput} value={input.name} placeholder={'Enter company name'} required />
                                                ...
                                                <label className={'w-100'}>
                                                    ...
                                                    <input className={errors.email != undefined ? "form-control is-invalid" : "form-control"}
                                                           type="email" name={"email"} onChange={handleInput} value={input.email} placeholder={'Enter company email'} required />
                                            ...
                                            <div className="card-body">
                                                <label className={'w-100'}>
                                                    ...
                                                    <input className={errors.address != undefined ? "form-control is-invalid" : "form-control"}
                                                           type="text" name={"address"} onChange={handleInput} value={input.address} placeholder={'Enter company address'} required />
